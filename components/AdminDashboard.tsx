          ...
          <div>
            ...
            <div className="flex flex-col gap-1 mt-1">
              ...
              <div className="flex items-center gap-1.5">
                ...
                <span className={`text-[7px] font-black ${supabaseStatus?.connected ? 'text-blue-500' : 'text-red-500'} uppercase tracking-[0.1em]`}>
                  Supabase: {supabaseStatus?.connected ? 'Kết nối OK' : `Lỗi: ${supabaseStatus?.error || 'Mất kết nối'}`}
                </span>
              </div>
            </div>
          </div>
